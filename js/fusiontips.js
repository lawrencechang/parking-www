      ...
      try {
        ...
        if (data) {
          ...
          if (numRows > 0) {
            ...
            //html += "TierLawrence " + data.rows[0][0];
            html += "" + data.rows[0][0] + "<br/>";
            html += "" + data.rows[0][1] + "<br/>";
            html += "validSunday: " + data.rows[0][2] + "<br/>";
            html += "validMonday: " + data.rows[0][3] + "<br/>";
            html += "validTuesday: " + data.rows[0][4] + "<br/>";
            html += "validWednesday: " + data.rows[0][5] + "<br/>";
            html += "validThursday: " + data.rows[0][6] + "<br/>";
            html += "validFriday: " + data.rows[0][7] + "<br/>";
            html += "validSaturday: " + data.rows[0][8] + "<br/>";
        ...
        console.log(err);
        if (!data.rows) {
          console.log("data.rows is undefined.");
          console.log(data);
        }
      }  
    }
